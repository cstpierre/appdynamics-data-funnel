...
public class NodesFunnel implements FunnelInterface, Runnable
{
	...
	public void initialize(String funnelName, String outputType, long startEpoch, long endEpoch, ControllerConfiguration conf, Element funnelDefinition) throws AppDFunnelInstantiationError 
	{
		...
		Node nodeidNode = funnelDefinition.selectSingleNode( "nodeid" );
		if (nodeidNode == null)
		{
			throw new AppDFunnelInstantiationError("Unable to retrieve a nodeid node under this funnel definition. Cannot continue.");
		}
		else
		{
			String nodeVal = nodeidNode.getText();
	...
	public String getRESTURL() throws AppDFunnelExecutionError 
	{
		...
		try
		{
			...
			else
			{
				...
				builder.append(java.net.URLEncoder.encode(nodeid, "ISO-8859-1"));
				builder.append("?output=");
				builder.append(output);
			}
	...
	{
		//System.out.println("Executing Nodes Funnel: " + name);
