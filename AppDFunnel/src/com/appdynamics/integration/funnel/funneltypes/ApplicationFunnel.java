...
public class ApplicationFunnel implements FunnelInterface, Runnable 
{
	...
	public String getRESTURL() throws AppDFunnelExecutionError 
	{
		...
		try
		{
			...
			builder.append("/controller/rest/applications?output=");
	...
	{
		// System.out.println("Executing Application Funnel: " + name);
